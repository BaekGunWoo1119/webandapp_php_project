...
<div id="mainWrapper">
  ...
  <div id="content" style ="overflow:visible;">
    <section class="sidebar" style ="position:relative; z-index: 5;"> 
 	 <!-- 검색 창, 검색 엔진 부분 -->
	...
	<section>
	<nav class="menu"style = "position:relative; left:1%; overflow:visible; text-align:center;">
	<?php
	...
	<h2><?php echo $board['title']; ?></h2>
		<div id="user_info">
			...
			<div style = "position:relative; width:1200px; right:28%">
	...
	<!-- 목록, 수정, 삭제 -->
	<div id="bo_ser" >
		<a style= "position:relative; left:24%;" href="thumbup.php?idx=<?php echo $board['idx']; ?>">
				<img src = "/wnateam/Assets/images/thumbup.png"style= "width:30%; height:7%;"></a><br>
			<h3 style= "position:relative; left:24%; color:#4aa8d8;"><?php echo $board['thumbup']; ?></h3>
		<br>
		<br>
		<ul style= "position:relative; width:120%; left: 110%; z-index:4;">
			<li><a href="javascript:history.back();"><img src = "/wnateam/Assets/images/list.png"></a></li>
			<li><a href="https://wnateam-bieok.run.goorm.io/wnateam/board/modify1.php?idx=<?php echo $board['idx']; ?>"><img src = "/wnateam/Assets/images/modify.png"></a></li>
			<li><a href="https://wnateam-bieok.run.goorm.io/wnateam/board<?php 
				if($board['boardtype'] == 1){} else{echo $board['boardtype'];}; ?>/delete<?php echo $board['boardtype']; ?>.php?idx=<?php echo $board['idx']; ?>"><img src = "/wnateam/Assets/images/delete.png"></a></li>
		</ul>
	</div>
	</div>
	</nav>
	...
	<br>
		<?php
			$sql3 = mq("select * from reply1 where con_num='".$bno."' order by idx desc");
			while($reply = $sql3->fetch_array()){ 
		?>
		<div class="dap_lo" style = "text-align:left;">
			<div><b><?php echo $reply['name'];?></b></div>
			<div class="dap_to comt_edit"><?php echo nl2br("$reply[content]"); ?></div>
			<div class="rep_me dap_to"><?php echo $reply['date']; ?></div>
			<div class="rep_me rep_menu">
				<a href="#" onclick="window.open('reply_edit1.php?idx=<?php echo $reply['idx'];?>&bno=<?php echo $bno;?>', '댓글 수정','width=600px, height=600px'); return false">수정</a>
				<a href="#" onclick="window.open('reply_delete1.php?idx=<?php echo $reply['idx'];?>&bno=<?php echo $bno;?>', '댓글 삭제','width=600px, height=600px'); return false">삭제</a>
			</div>
			<!-- 댓글 삭제 비밀번호 확인 -->
	...
	<!--- 댓글 입력 폼 -->
	<div class="dap_ins">
		<form action="/wnateam/board/reply_ok1.php?idx=<?php echo $bno; ?>" method="post">
			<?php if(!$userid){?>
